          ...
          >
              ...
              showGame && (
                <div id="gameDiv">
                  ...
                  <div id="gameClipDiv">
                    ...
                    <iframe src="./assets/game/index.html"  frameBorder="0" scrolling="no">
                    </iframe>
                  </div>
                </div>
              )
            ...
            { showMusic && (
              <div id="musicDiv">
                <div id="musicClipDiv">
                  <h4>Music</h4>
                  <iframe src="./assets/musicPlayer/index.html" frameBorder="0" scrolling="no">
                  </iframe>
                </div>
              </div>
              )
            ...
            { showChat && (
              <div id="chatDiv">
                <div id="chatClipDiv">
                  <h4>Chat</h4>
                <iframe src="./assets/chat/index.html" frameBorder="0" scrolling="yes"></iframe>
                </div>
              </div>
              )
            }
