          ...
          >
            ...
            { showMusic && (
              <div id="musicDiv">
                <div id="musicClipDiv">
                  <h4>Music</h4>
                  <iframe src={'musicPlayer/index.html'} frameBorder="0" scrolling="no" referrerPolicy="strict-origin-when-cross-origin">
                  </iframe>
                </div>
              </div>
              )
            ...
            { showChat && (
              <div id="chatDiv">
                <div id="chatClipDiv">
                  <h4>Chat</h4>
                <iframe src={'chat/index.html'} frameBorder="0" scrolling="yes" referrerPolicy="strict-origin-when-cross-origin"></iframe>
                </div>
              </div>
              )
            }
